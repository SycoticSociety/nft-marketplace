					...
					<div className="grid grid-cols-1 gap-[1.875rem] md:grid-cols-2 lg:grid-cols-4">
						{data.map((item) => {
							...
							const itemLink = bigImage
								...
								.replace('.gif', '');
							return (
								<article className="dark:bg-jacarata-800" key={id}>
									<div className="dark:bg-jacarta-900 dark:border-jacarta-700 border-jacarta-100 rounded-2xl block border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg">
										<div className="mb-4 flex items-center justify-between relative">
											<div className="flex -space-x-2 ">
												<Tippy
													theme="tomato"
													content={<span className="py-1 px-2 block">Creator: Sussygirl</span>}
												>
										...
										<div className="mt-2 text-sm">
											...
											<span className="dark:text-jacarta-100 text-jacarta-700">{price}</span>
										</div>
										...
										<div className="mt-8 flex items-center justify-between">
											...
											<Likes like={likes} classes="flex items-center space-x-1" />
										</div>
									</div>
								</article>
							);
