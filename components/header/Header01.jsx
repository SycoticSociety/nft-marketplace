          ...
          <div id="#wallet" className="ml-auto flex lg:hidden">
             <Link href="/">
              ...
              >
                ...
                >
                  <path fill="none" d="M0 0h24v24H0z" />
                  <path d="M10 20V14h4v6h5V12h3L12 3 2 12h3v8z"></path>
                </svg>
              </a>
            </Link> 
            <button
      ...
      >
        ...
        <div className="mt-10 w-full lg:hidden">
          ...
          <div className="flex items-center justify-center space-x-5">
            ...
            <Link href='https://discord.com/invite/HZH35GhyRV'>
            <a className="group">
              <svg
                aria-hidden="true"
                focusable="false"
            ...
            <Link href='https://www.instagram.com/sycoticsociety/?hl=en'>
            <a className="group">
              <svg
                aria-hidden="true"
                focusable="false"
